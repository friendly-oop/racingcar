...
public class RacingDistanceCount {
    private static final String DISTANCE_COUNT_EXCEPTION_MESSAGE = "이동횟수가 null이면 안 됩니다.";
    private static final String DISTANCE_COUNT_NEGATIVE_EXCEPTION_MESSAGE = "이동횟수가 음수이면 안 됩니다.";
